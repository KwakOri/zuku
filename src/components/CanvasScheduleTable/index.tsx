...
export default function CanvasScheduleTable({ className = '' }: CanvasScheduleTableProps) {
  ...
  // 학생 행 그리기
  const drawStudentRow = (ctx: CanvasRenderingContext2D, canvas: HTMLCanvasElement, schedule: any, rowIndex: number) => {
  ...
  // 스케줄 블록 그리기
  const drawScheduleBlock = (ctx: CanvasRenderingContext2D, scheduleItem: any, dayStartX: number, rowY: number, dayStartHour: number) => {
      ...
      <div className="bg-white shadow-sm rounded-lg border border-gray-200">
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex justify-between items-start mb-4">
            <div>
              <h2 className="text-lg font-semibold text-gray-900">Canvas 시간표</h2>
          ...
          <div className="mt-4 text-sm text-gray-600">
            총 {filteredSchedules.length}명의 학생 | 5분 단위 정밀도 | 1시간 격자 표시
          </div>
        </div>
